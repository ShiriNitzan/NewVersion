...
%% choose measures
if(ScenarioNumber == 0)
    prompt = "1. Population Growth"+ newline + "2. Electricity Per Capita" + newline + "3. Desalinated Water" + newline + "4. Beef Consumption" + newline +"5. Food Loss";
    ChooseSteps = inputdlg(prompt,'Choose Steps', [1 35]);
    if(strcmp(ChooseSteps{1}, 'All'))
        ChooseSteps = 1:1:length(S);
    else
        ChooseSteps = str2num(ChooseSteps{1});
        if(ChooseSteps(1) < 0)
