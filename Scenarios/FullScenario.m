function [EmissionsByYears,ConsumptionAmounts, Resources, WaterFromFoodCell] = FullScenario(Data, ScenariosTable,Years)
...
[ElectricityConsumptionTable, TransportationConsumptionTable, VehicleAmountsCell, FoodConsumptionCell, WaterConsumptionCell, ConstructionTable,WasteAndRecyclingCell, OrganicWasteCell] = ConsumptionChanges(Data, ConsumptionChangesTable, Years);
...
%% change in diselinated water consumption - scenario 3
...
TotalArea = 0;
for i = 1:Years
    CurrentAreaCoefficient = Data.AreaForSolarEnergyCoefficients{i,:};
