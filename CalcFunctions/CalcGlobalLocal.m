function [GlobalLocalEmission, TotalGlobalLocal] = CalcGlobalLocal(EmissionsByYears)
    ...
    for i = 1:width(EmissionsByYears)
        ...
        GlobalLocalEmission{2,i}.Electricity(1) = (EmissionsByYears{3,i}{1,1}{1,7}+EmissionsByYears{3,i}{1,1}{5,7})/1000000;
        ...
        GlobalLocalEmission{2,i}.Transportation(1) = EmissionsByYears{6,i}{1,1}{6,7}/1000000;
