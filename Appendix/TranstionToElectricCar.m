function [EmissionsByYears, ConsumptionAmounts] = TranstionToElectricCar(Data, ChangeByYears, Years)
%% Preparations
...
%% Transportation - Downstream
    ...
    ElectricityConsumptionEmissionsInTransportation = table2array(readtable(Data,'Sheet','ElectricityConsumption','Range','I23:I26','ReadVariableNames',false))';

    KWHForElectricCar = zeros(1,Years);
    for i = 1:Years
        KMTraveledByElectricCar = TransportationConsumptionTable{2,i}*ChangeByYears(i);
        KWHForElectricCar(i) = (TransportationConsumptionTable{2,i}-KMTraveledByElectricCar)*ElectricityConsumptionEmissionsInTransportation(1);
        TransportationConsumptionTable{2,i} = KMTraveledByElectricCar;
    ...
    ElectricityConsumptionTable{5,:} = KWHForElectricCar;
    ...
    disp(ElectricityConsumptionTable);
