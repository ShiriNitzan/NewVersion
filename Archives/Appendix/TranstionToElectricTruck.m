function [EmissionsByYears, ConsumptionAmounts] = TranstionToElectricTruck(Data, ChangeByYears, Years, ElectricityConsumptionEmissionsInTransportation)
%% Preparations
...
%% Transportation - Downstream
    ...
    for i = 1:Years
        KMTraveledByElectricTruck= TransportationConsumptionTable{5,i}*ChangeByYears(i);
        KWHForElectricCar(i) = (TransportationConsumptionTable{5,i}-KMTraveledByElectricTruck)*ElectricityConsumptionEmissionsInTransportation(4);
        TransportationConsumptionTable{5,i} = KMTraveledByElectricTruck;
