function [EmissionsByYears, ConsumptionAmounts] = TranstionToElectricBus(Data, ChangeByYears, Years, ElectricityConsumptionEmissionsInTransportation)
%% Preparations
...
%% Transportation - Downstream
    ...
    for i = 1:Years
        KMTraveledByElectricBus= TransportationConsumptionTable{1,i}*ChangeByYears(i);
        KWHForElectricCar(i) = (TransportationConsumptionTable{1,i}-KMTraveledByElectricBus)*ElectricityConsumptionEmissionsInTransportation(4);
        TransportationConsumptionTable{1,i} = KMTraveledByElectricBus;
